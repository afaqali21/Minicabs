...
const Flightdetail = ({ onFlightchange }) => {
   ...
   }, [ arrived, landed, flightno, meet, onFlightchange]);
            ...
            <div className='container mx-auto'>
                <div className='bg-colorGrey px-4 py-8 my-7'>
                    ...
                    <div className="relative w-1/2 mt-4">
                        <input type="text"
                        value={arrived} 
                        onChange={handleInputChange}  id="arrived" className="block px-2.5 pb-2.5 pt-4 w-full
                        ...
                        <label htmlFor="arrived" className="absolute text-sm text-gray-500  duration-300 
                    ...
                    <div className="relative w-1/2 mt-4">
                        <input type="text" value={landed} 
                        onChange={handleInputChange} id="landed" className="block px-2.5 pb-2.5 pt-4 w-full
                                text-sm text-gray-900 bg-white rounded border-2 border-[#A9ACB3] appearance-none
                                focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                        <label htmlFor="landed" className="absolute text-sm text-gray-500  duration-300 
                                transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2
                             peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 
                ...
                <div className='flex space-x-2'>
                    <div className="relative w-1/2 mt-4">
                        <input type="text" value={flightno} 
                        onChange={handleInputChange} id="flightno" className="block px-2.5 pb-2.5 pt-4 w-full
                                text-sm text-gray-900 bg-white rounded border-2 border-[#A9ACB3] appearance-none
                                focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                        <label htmlFor="flightno" className="absolute text-sm text-gray-500  duration-300 
                                  transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2
                                  peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 
                    ...
                    <div className="relative w-1/2 mt-4">
                        <input type="text"
                        value={meet} 
                        onChange={handleInputChange} id="meet" className="block px-2.5 pb-2.5 pt-4 w-full
                                text-sm text-gray-900 bg-white rounded border-2 border-[#A9ACB3] appearance-none
                                focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                        <label htmlFor="meet" className="absolute text-sm text-gray-500  duration-300 
                                transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2
                             peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 
