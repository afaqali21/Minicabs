...
const VehicleDetailSucess = ({ selectedCar }) => {
    return (
        <div>
                ...
                <div className='bg-colorGrey px-5 py-8 my-7'>
                    ...
                    <div className='grid  md:grid-cols-2'>
                        <div className='grid grid-cols-2'>
                            ...
                            <div>
                                <p className='text-hColor'>Passengers</p>
                                <p className='text-hColor font-semibold'>{selectedCar?.passengers}</p>
                            </div>
                            <div>
                                <p className='text-hColor'>Luggage</p>
                                <p className='text-hColor font-semibold'>{selectedCar?.luggage}</p>
                            </div>
                        </div>
