                ...
                <div className='bg-colorGrey px-5 py-8 my-7'>
                    ...
                    <div class="relative">
                        <div className='flex space-x-2 '>
                            ...
                            <div >
                                ...
                                <p className='text-hColor font-semibold pb-4'>Ealing Broadway Station New Ealing Broadway</p>
                            </div>
                        </div>
                        ...
                        <div className='flex space-x-2'>
                            ...
                            <div >
                                ...
                                <p className='text-hColor font-semibold'>Queensbury Station, Queensbury Parade HA8 5NN</p>
                            </div>
                        </div>
                    </div>
                    <div className='grid grid-cols-4 pt-6'>
                        <div className=''>
                            ...
                            <p className='text-hColor font-semibold pb-4'>USA</p>
                        </div>
                        <div className=''>
                            <p className='text-hColor'>Landing Time</p>
                            <p className='text-hColor font-semibold pb-4'>10:30 am</p>
                        </div>
                        <div className=''>
                            <p className='text-hColor'>Flight No</p>
                            <p className='text-hColor font-semibold pb-4'>BA2490</p>
                        </div>
                        <div className=''>
                            <p className='text-hColor'>Driver Meeting Time</p>
                            <p className='text-hColor font-semibold pb-4'>04:00 pm</p>
                        </div>
                    </div>
                </div>
            </div>
