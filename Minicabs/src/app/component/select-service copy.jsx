                        ...
                        {carData.map((car, index) => (
                            ...
                            >
                                ...
                                <div className="flex text-center mx-auto">
                                    <div className="flex">
                                        <img src="/booking-engine-img/user.png" alt="Passengers" />
                                        <p className="text-hColor">{car.passengers}</p>
                                    </div>
                                    <div className="flex pl-2">
                                        <img src="/booking-engine-img/suitcase.png" alt="Luggage" />
                                        <p className="text-hColor pl-1">{car.luggage}</p>
                                    </div>
                                </div>
